...
; =============================================================================
  ...
  swap       d0                           ;  4(1/0)
; 	; -------------------------------------------------------------------------
;   movem.w    (a0),d0-a0/a3/a5             ; 12+4m(3+m/0)    TODO
...
;   divs.w     #i16,d0                      ; 120+?(1/0) +  8(2/0) = 128+?(3/0)
  ...
  exg.l      d0,a0                        ;  6(1/0)
	; -------------------------------------------------------------------------
;   mulu.w     d0,d0                        ; 38+2m(1/0) +  0(0/0) = 	; m = popcount(src)       TODO
;   mulu.w     (a0),d0                      ; 38+2m(1/0) +  4(1/0) = 	; m = popcount(src)
;   mulu.w     (a0)+,d0                     ; 38+2m(1/0) +  4(1/0) = 	; m = popcount(src)
;   mulu.w     -(a0),d0                     ; 38+2m(1/0) +  6(1/0) = 	; m = popcount(src)
;   mulu.w     i16(a0),d0                   ; 38+2m(1/0) +  8(2/0) = 	; m = popcount(src)
;   mulu.w     *+i16(pc),d0                 ; 38+2m(1/0) +  8(2/0) = 	; m = popcount(src)
;   mulu.w     i8(a0,d0.w),d0               ; 38+2m(1/0) + 10(2/0) = 	; m = popcount(src)
;   mulu.w     i8(a0,a0.w),d0               ; 38+2m(1/0) + 10(2/0) = 	; m = popcount(src)
;   mulu.w     i8(a0,d0.l),d0               ; 38+2m(1/0) + 10(2/0) = 	; m = popcount(src)
;   mulu.w     i8(a0,a0.l),d0               ; 38+2m(1/0) + 10(2/0) = 	; m = popcount(src)
;   mulu.w     *+i8(pc,d0.w),d0             ; 38+2m(1/0) + 10(2/0) = 	; m = popcount(src)
;   mulu.w     *+i8(pc,a0.w),d0             ; 38+2m(1/0) + 10(2/0) = 	; m = popcount(src)
;   mulu.w     *+i8(pc,d0.l),d0             ; 38+2m(1/0) + 10(2/0) = 	; m = popcount(src)
;   mulu.w     *+i8(pc,a0.l),d0             ; 38+2m(1/0) + 10(2/0) = 	; m = popcount(src)
;   mulu.w     (xxx).w,d0                   ; 38+2m(1/0) +  8(2/0) = 	; m = popcount(src)
;   mulu.w     (xxx).l,d0                   ; 38+2m(1/0) + 12(2/0) = 	; m = popcount(src)
;   mulu.w     #i16,d0                      ; 38+2m(1/0) +  8(2/0) = 	; m = popcount(src)
; 	; -------------------------------------------------------------------------
;   muls.w     d0,d0                        ; 38+2m(1/0) +  0(0/0) = 	; m = popcount((src^(src<<1))&0xFFFF)
;   muls.w     (a0),d0                      ; 38+2m(1/0) +  4(1/0) = 	; m = popcount((src^(src<<1))&0xFFFF)
;   muls.w     (a0)+,d0                     ; 38+2m(1/0) +  4(1/0) = 	; m = popcount((src^(src<<1))&0xFFFF)
;   muls.w     -(a0),d0                     ; 38+2m(1/0) +  6(1/0) = 	; m = popcount((src^(src<<1))&0xFFFF)
;   muls.w     i16(a0),d0                   ; 38+2m(1/0) +  8(2/0) = 	; m = popcount((src^(src<<1))&0xFFFF)
;   muls.w     *+i16(pc),d0                 ; 38+2m(1/0) +  8(2/0) = 	; m = popcount((src^(src<<1))&0xFFFF)
;   muls.w     i8(a0,d0.w),d0               ; 38+2m(1/0) + 10(2/0) = 	; m = popcount((src^(src<<1))&0xFFFF)
;   muls.w     i8(a0,a0.w),d0               ; 38+2m(1/0) + 10(2/0) = 	; m = popcount((src^(src<<1))&0xFFFF)
;   muls.w     i8(a0,d0.l),d0               ; 38+2m(1/0) + 10(2/0) = 	; m = popcount((src^(src<<1))&0xFFFF)
;   muls.w     i8(a0,a0.l),d0               ; 38+2m(1/0) + 10(2/0) = 	; m = popcount((src^(src<<1))&0xFFFF)
;   muls.w     *+i8(pc,d0.w),d0             ; 38+2m(1/0) + 10(2/0) = 	; m = popcount((src^(src<<1))&0xFFFF)
;   muls.w     *+i8(pc,a0.w),d0             ; 38+2m(1/0) + 10(2/0) = 	; m = popcount((src^(src<<1))&0xFFFF)
;   muls.w     *+i8(pc,d0.l),d0             ; 38+2m(1/0) + 10(2/0) = 	; m = popcount((src^(src<<1))&0xFFFF)
;   muls.w     *+i8(pc,a0.l),d0             ; 38+2m(1/0) + 10(2/0) = 	; m = popcount((src^(src<<1))&0xFFFF)
;   muls.w     (xxx).w,d0                   ; 38+2m(1/0) +  8(2/0) = 	; m = popcount((src^(src<<1))&0xFFFF)
;   muls.w     (xxx).l,d0                   ; 38+2m(1/0) + 12(2/0) = 	; m = popcount((src^(src<<1))&0xFFFF)
;   muls.w     #i16,d0                      ; 38+2m(1/0) +  8(2/0) = 	; m = popcount((src^(src<<1))&0xFFFF)
	; -------------------------------------------------------------------------
